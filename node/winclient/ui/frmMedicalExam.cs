...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmMedicalExam : Form
    {
        ...
        {
            if(grdDataMedicalExamFields.Selected.Rows.Count == 0)
            {
                return;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (objProtocolBL.ValidateComponentElimination(ref objOperationResult, strMedicalExamId) == true)
                {
                    //Validación para no borrar campos del Componente ya en USO en algun Protocolo
                    //MessageBox.Show("Este registro no se puede eliminar porque está referenciado en un protocolo.", "¡ADVERTENCIA!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    //return;
                }
        ...
        private void btnCloneComponent_Click(object sender, EventArgs e)
        {
            OperationResult objOperationResult = new OperationResult();
            string strMedicalExamId = grdDataMedicalExam.Selected.Rows[0].Cells[0].Value.ToString();
            DialogResult Result = MessageBox.Show("¿Está seguro de CLONAR este componente?:" + System.Environment.NewLine + objOperationResult.ExceptionMessage, "¡ADVERTENCIA!", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);

            if (Result == System.Windows.Forms.DialogResult.Yes)
            {
                var componentIdDestine =  "N003-ME000000067";
                var strFilterExpression = "v_ComponentId ==" + "\"" + strMedicalExamId + "\"";
                var componentsDB = GetDataMedicalExamFields(0, null, "v_Group , v_TextLabel ASC", strFilterExpression);

                foreach (var componentDB in componentsDB)
                {
                    var objmedicalexamfieldDto = new componentfieldDto();
                    var objmedicalexamfieldsDto = new componentfieldsDto();

                    #region ComponentFieldDto

                    objmedicalexamfieldDto.v_TextLabel = "_"+ componentDB.v_TextLabel;
                    objmedicalexamfieldDto.v_abbreviation = componentDB.v_Abbreviation;
                    objmedicalexamfieldDto.i_LabelWidth = componentDB.i_LabelWidth;
                    objmedicalexamfieldDto.r_ValidateValue1 = componentDB.r_ValidateValue1;
                    objmedicalexamfieldDto.r_ValidateValue2 = componentDB.r_ValidateValue2;
                    objmedicalexamfieldDto.i_MaxLenght = componentDB.i_MaxLenght;
                    objmedicalexamfieldDto.i_IsRequired = componentDB.i_IsRequired;
                    objmedicalexamfieldDto.i_IsCalculate = componentDB.i_IsCalculate;
                    objmedicalexamfieldDto.i_NroDecimales = componentDB.i_NroDecimales;
                    objmedicalexamfieldDto.i_Enabled = componentDB.i_Enabled;
                    objmedicalexamfieldDto.i_ReadOnly = componentDB.i_ReadOnly;

                    objmedicalexamfieldDto.i_ControlId = componentDB.i_ControlId;
                    objmedicalexamfieldDto.i_Column = componentDB.i_Column;
                    objmedicalexamfieldDto.i_MeasurementUnitId = componentDB.i_MeasurementUnitId;
                    objmedicalexamfieldDto.i_GroupId = componentDB.i_GroupId;
                    objmedicalexamfieldDto.i_ItemId = componentDB.i_ItemId;
                    objmedicalexamfieldDto.i_WidthControl = componentDB.i_WidthControl;
                    objmedicalexamfieldDto.i_HeightControl = componentDB.i_HeightControl;
                    objmedicalexamfieldDto.i_Order = componentDB.i_Order;
                    objmedicalexamfieldDto.v_Formula = componentDB.v_Formula;
                    objmedicalexamfieldDto.v_DefaultText = componentDB.v_DefaultText;

                    objmedicalexamfieldsDto.v_Group = componentDB.v_Group;
                    objmedicalexamfieldsDto.v_ComponentId = componentIdDestine;

                    #endregion

                    var medicalExamFliedId = _objMedicalExamFieldsBL.AddMedicalExamFields(ref objOperationResult, objmedicalexamfieldDto, objmedicalexamfieldsDto, componentIdDestine, Globals.ClientSession.GetAsList());
                }
            }
        }
    }
