...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmPacient : Form
    {
        ...
        {
            if (txtFirstLastNameDocNumber.Text == "")
            {
                var objData = GetData(0, null, txtPersonId.Text.Trim());
            ...
            if (grdData.Rows.Count > 0)
            {
                if (_personId != null)
                {
                    ...
                    //    grdData.ActiveRowScrollRegion.ScrollPosition = findIndex;
                    //}
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (uvPacient.Validate(true, false).IsValid)
            {
                ...
                {
                    MessageBox.Show("Por favor ingrese al menos un número de celular(ejem:999999999,888888888).", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
