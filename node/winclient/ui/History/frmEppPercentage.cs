...
namespace Sigesoft.Node.WinClient.UI.History
{
    public partial class frmEppPercentage : Form
    {
        ...
        {
            if (txtPorcentage.Text == "" || txtPorcentage.Text == "0" )
            {
                MessageBox.Show("Este campo no puede estar vacio ni ser 0 ", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
             
            }
            else if( int.Parse(txtPorcentage.Text.ToString()) > 100  )
            {
