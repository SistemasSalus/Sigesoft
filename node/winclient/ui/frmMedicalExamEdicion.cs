    ...
    { 
        ...
        private void frmMedicalExamEdicion_Load(object sender, EventArgs e)
        {
            ...
            else if (Mode == "Edit")
            {
                ...
                unCostPrice.Text = objmedicalexamDto.r_CostPrice.ToString();
                unSalePrice.Text = objmedicalexamDto.r_SalePrice.ToString();
            ...
            if (uvMedicalExamEdit.Validate(true, false).IsValid)
            {
                 ...
                 if (Mode == "New")
                {
                    ...
                    objmedicalexamDto.v_Name = txtInsertName.Text;
                        ...
                        objmedicalexamDto.r_CostPrice = float.Parse(unCostPrice.Text);
                        objmedicalexamDto.r_SalePrice = float.Parse(unSalePrice.Text);
