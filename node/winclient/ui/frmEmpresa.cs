...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmEmpresa : Form
    {
        ...
        private void frmAdministracion_Load(object sender, EventArgs e)
        {
            ...
            //Llenado de combos
            Utils.LoadDropDownList(ddlOrganizationTypeId1, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo(ref objOperationResult, 103,null), DropDownListAction.All, true);
            ddlOrganizationTypeId1.SelectedValue = 2;
            Utils.LoadDropDownList(ddlSectorTypeId1, "Value1", "Id", BLL.Utils.GetDataHierarchyForCombo(ref objOperationResult, 104,null), DropDownListAction.All, true);
        ...
        private void ActivarControles(Boolean valor){
            ...
            chkVigCovid.Enabled = valor;
            groupBox13.Enabled = valor;
        ...
        private void FillCombo()
        {
            ...
            // TAB GESO - Location
            Utils.LoadDropDownList(ddlSearchGESOLocation, "Value1", "Id", BLL.Utils.GetLocation(ref objOperationResult, _organizationId), DropDownListAction.All, true);
            Utils.LoadDropDownList(dllInsertGESOLocation, "Value1", "Id", BLL.Utils.GetLocation(ref objOperationResult, _organizationId), DropDownListAction.Select, true);
        ...
        private void LoadData(string pstrOrganizationId, string pstrMode)
        {
            ...
            Mode = pstrMode;
            OperationResult objOperationResult = new OperationResult();
            Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetJoinOrganizationAndLocation_(ref objOperationResult, Globals.ClientSession.i_CurrentExecutionNodeId), DropDownListAction.All, true);
            // DZERVER Buscar TEXTO en CBPadre

            Utils.LoadDropDownList(ddlOrganizationypeId1, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo(ref objOperationResult, 103, null), DropDownListAction.All, true);

            Utils.LoadDropDownList(ddlSectorTypeId, "Value1", "Id", BLL.Utils.GetDataHierarchyForCombo(ref objOperationResult, 104, null), DropDownListAction.All, true);
            ...
            else if (Mode == "Edit")
            {
                ...
                cbPadre.SelectedValue = objOrganizationDto.v_OrganizationPadreId== null ? "-1" : objOrganizationDto.v_OrganizationPadreId.ToString();
                ...
                chkVigCovid.Checked = objOrganizationDto.i_VigCovid19 == 1 ? true : false;

                if (objOrganizationDto.i_TipoFormatoCovid19 == 2)
                {
                    rbFormatoCorto.Checked = true;
                }
                else
                {
                    rbformatoDetallado.Checked = true;
                }
        ...
        private void btnInsertLocation_Click(object sender, EventArgs e)
        {
            ...
            if (uvSede.Validate(true, false).IsValid)
            {
                ...
                if (txtInsertCorreosSede.Text.Trim() == "")
                {
                    MessageBox.Show("Por favor ingrese un correos para cada sede.", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                if (ModeLocation == "New")
                {
                    ...
                    objLocationDto.v_Email = txtInsertCorreosSede.Text;
                    // Save the data
                ...
                #region còdigo comentado

                //// prueba ***************************************

                //Rutina para Asignar la Empresa creada automaticamente al nodo actual (MASIVAMENTE TODAS LA EMPRESAS ALA AVEZ)
                //var query = _objBL.GetAllOrganizationsAndLocation();
                ...
                //    //Llenar Entidad Empresa/sede
                //    objNodeOrganizationLoactionWarehouseList.i_NodeId = Globals.ClientSession.i_CurrentExecutionNodeId;
                //    objNodeOrganizationLoactionWarehouseList.v_OrganizationId = item.v_OrganizationId;
                //    objNodeOrganizationLoactionWarehouseList.v_LocationId = item.v_LocationId;

                //    //Llenar Entidad Almacén
                //    var objInsertWarehouseList = InsertWarehouse(item.v_LocationId);

                //    _objBL.AddNodeOrganizationLoactionWarehouse(ref objOperationResult, objNodeOrganizationLoactionWarehouseList, objInsertWarehouseList, Globals.ClientSession.GetAsList());

                //}

                //var queryFilter = _objBL.GetAllOrganizationsAndLocation().FindAll(p => p.v_OrganizationId != "N009-OO000000142");
                ...
                //    objgroupoccupationDto.v_LocationId = item.v_LocationId;
                //    // Save the data
                ...
                //    objgroupoccupationDto = new groupoccupationDto();
                //    // Populate the entity
                //    objgroupoccupationDto.v_Name = "Operativo";
                //    objgroupoccupationDto.v_LocationId = item.v_LocationId;
                //    // Save the data
                //    Globals.ClientSession.i_CurrentExecutionNodeId = 1;
                //    _objGroupOccupationBL.AddGroupOccupation(ref objOperationResult, objgroupoccupationDto, Globals.ClientSession.GetAsList());
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (uvOrganization.Validate(true, false).IsValid)
            {
                ...
                if (cbPadre.SelectedValue.ToString() !="-1")
                {
                      var dataList = cbPadre.SelectedValue.ToString().Split('|');
                      idOrg = dataList[0];
                }
                ...
                if (Mode == "New")
                {
                    objOrganizationDto = new organizationDto();
                    // Populate the entity
                    objOrganizationDto.v_OrganizationPadreId = idOrg;
                    ...
                    objOrganizationDto.i_VigCovid19 = chkVigCovid.Checked == true ? 1 : 0;

                    if (rbFormatoCorto.Checked)
                    {
                        objOrganizationDto.i_TipoFormatoCovid19 = 2;
                    }
                    else
                    {
                        objOrganizationDto.i_TipoFormatoCovid19 = 1;
                    }
                    ...
                    //DZERVER retiro estas lineas para quitar validacion de número de ruc
                    ...
                    {
                        if (MessageBox.Show("El Nro. Identificación ya existe; Está seguro de repetirlo?" + System.Environment.NewLine + objOperationResult.ExceptionMessage, "ADVERTENCIA!", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                    ...
                    //DZERVER estas lineas grba sin verificar el número de ruc
                    //_organizationId = _objBL.AddOrganization(ref objOperationResult, objOrganizationDto, Globals.ClientSession.GetAsList());
                ...
                else if (Mode == "Edit")
                {
                    ...
                    //DZerveR Agrego para que se llene nuevamente la lista con esta nueva empresa
                    Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetJoinOrganizationAndLocation_(ref objOperationResult, Globals.ClientSession.i_CurrentExecutionNodeId), DropDownListAction.All, true);
            ...
            //DZERVER Refrescar CBPadre con las nuevas creaciones
            Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetJoinOrganizationAndLocation_(ref objOperationResult, Globals.ClientSession.i_CurrentExecutionNodeId), DropDownListAction.Select);
            // DZERVER Buscar en CBPadre
            Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetAllEmpresaPadre(ref objOperationResult), DropDownListAction.All, true);
        }
        ...
        private void btnInsertGeso_Click(object sender, EventArgs e)
        {
            ...
            ////// prueba (Crear masivamente GESOs para todas la empresas / sedes) ***************************************     
       ...
       private void btnEditarSede_Click(object sender, EventArgs e)
        {
            ...
            txtInsertCorreosSede.Text = objLocationDto.v_Email;
            ModeLocation = "Edit";
        }
        ...
        private void cbPadre_SelectedValueChanged(object sender, EventArgs e)
        {
