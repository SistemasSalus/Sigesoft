...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmSchedulePerson : Form
    {
        ...
        private void frmSchedulePerson_Load(object sender, EventArgs e)
        {
            ...
            //Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetAllEmpresaPadre(ref objOperationResult), DropDownListAction.Select);
            Utils.LoadDropDownList(cbPadre, "Value1", "Id", BLL.Utils.GetAllEmpresaPadre(ref objOperationResult), DropDownListAction.Select, true);

            //Utils.LoadDropDownList(cboEmpresaFacturacion, "Value1", "Id", BLL.Utils.LlenarComboHijo(null), DropDownListAction.Select, true);
            Utils.LoadDropDownList(cboEmpresaFacturacion, "Value1", "Id", BLL.Utils.GetAllEmpresaPadre(ref objOperationResult), DropDownListAction.Select, true);
        ...
        private void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            List<ServiceList>  objServiceList = new List<ServiceList>(); 
                ...
                if (objpacientDto != null)
                {
                    ...
                    objServiceList = objServiceBL.GetServicesPagedAndFiltered(ref objOperationResult, null, null, "", "v_PersonId=" + "\"" + PacientId + "\"",null,null);
        ...
        private void btnSavePacient_Click(object sender, EventArgs e)
        {
            ...
            if (uvPacient.Validate(true, false).IsValid)
            {
                ...
                {
                    MessageBox.Show("Por favor ingrese un número de celular(ejem:999999999).", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                if (txtMail.Text.Trim() == "")
                {
                    MessageBox.Show("Por favor ingrese un correo electrónico.", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        private void btnschedule_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Debe seleccionar una sede.", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                if (uvschedule.Validate(true, false).IsValid)
                {
                    ...
                    //if (cboEmpresaFacturacion.SelectedValue.ToString() == "--Seleccionar--")
                    //{
                    //    MessageBox.Show("Por favor seleccione un Empresa de Factuación.", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    //    return;
                    //}
                    ...
                    if (ModeAgenda == "New")
                    {
                        using (new LoadingClass.PleaseWait(this.Location, "Grabando..."))
                        {
                            ...
                            if (ddlMasterServiceId.SelectedValue.ToString() == ((int)MasterService.AtxMedicaParticular).ToString())
                            {
                                CalendarId = _objCalendarBL.AddShedule(ref objOperationResult, objCalendarDto, Globals.ClientSession.GetAsList(), Constants.CONSULTAMEDICA, PacientId, Int32.Parse(ddlMasterServiceId.SelectedValue.ToString()), NuevoContinuacion, cboEmpresaFacturacion.SelectedValue.ToString(), cboSede.Text.Trim());
                            }
                            else
                            {
                                CalendarId = _objCalendarBL.AddShedule(ref objOperationResult, objCalendarDto, Globals.ClientSession.GetAsList(), _ProtocolId, PacientId, Int32.Parse(ddlMasterServiceId.SelectedValue.ToString()), NuevoContinuacion, cboEmpresaFacturacion.SelectedValue.ToString(), cboSede.Text.Trim());
                            }
                    ...
                    if (objOperationResult.Success == 1)  // Operación sin error
                    {
                        ...
                        MessageBox.Show("Agenda creada con Éxito; BUENA NIÑA!!!.", "INFORMACION!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        this.Close();
                    }
                    else  // Operación con error
                    {
        ...
        {
            Configuration.frmProtocolManagement frm = new Configuration.frmProtocolManagement("View", int.Parse(ddlServiceTypeId.SelectedValue.ToString()), int.Parse(ddlMasterServiceId.SelectedValue.ToString()), cbPadre.SelectedValue.ToString());
            frm.ShowDialog();
        ...
        private void cbPadre_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            //if (cbPadre.SelectedValue == null || cbPadre.SelectedValue.ToString() == "-1")
            //{
                //Utils.LoadDropDownList(cboEmpresaFacturacion, "Value1", "Id", BLL.Utils.LlenarComboHijo(null), DropDownListAction.Select, true);
                //txtProtocolId.Text = string.Empty;
                //txtViewProtocol.Text = string.Empty;
                //txtViewOrganization.Text = string.Empty;
                //txtViewGroupOccupation.Text= string.Empty;
                //txtViewGes.Text = string.Empty;
                ...
                //txtViewOccupation.Text = string.Empty;
                //txtViewIntermediaryOrganization.Text = string.Empty;
                //txtIntermediaryOrganization.Text = string.Empty;
                //btnSearchProtocol.Enabled = false;
                //cboSede.SelectedValue = "-1";
            //}
            //else
            //{
            //    Utils.LoadDropDownList(cboEmpresaFacturacion, "Value1", "Id", BLL.Utils.LlenarComboHijo(cbPadre.SelectedValue.ToString()), DropDownListAction.Select, true);
            //    LocationBL oLocationBL = new LocationBL();
            //    var ListaSede = oLocationBL.GetAllEmpresaSedeByEmpresaId(cbPadre.SelectedValue.ToString());
            //    Utils.LoadDropDownList(cboSede, "Value1", "Id",ListaSede, DropDownListAction.Select, true);
            //    btnSearchProtocol.Enabled = true;


            //}
          
            //cboEmpresaFacturacion.DataSource = oProtocolBL.DevolverEmpresasHijo(cbPadre.SelectedValue.ToString());


            if (cbPadre.SelectedValue != null && cbPadre.SelectedValue.ToString() != "-1")
            {
                OperationResult objOperationResult = new OperationResult();
                Utils.LoadDropDownList(cboEmpresaFacturacion, "Value1", "Id", BLL.Utils.GetAllEmpresa(ref objOperationResult), DropDownListAction.Select, true);
                txtProtocolId.Text = string.Empty;
                txtViewProtocol.Text = string.Empty;
                txtViewOrganization.Text = string.Empty;
                txtViewGroupOccupation.Text = string.Empty;
