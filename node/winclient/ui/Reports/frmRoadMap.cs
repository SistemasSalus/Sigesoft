...
namespace Sigesoft.Node.WinClient.UI.Reports
{
    public partial class frmRoadMap : Form
    {
        ...
        private void ShowReport()
        {
            ...
            DataTable dtHeader = Sigesoft.Node.WinClient.BLL.Utils.ToDataTable(headerRoadMap);
            DataTable dtDetail = Sigesoft.Node.WinClient.BLL.Utils.ToDataTable(detailRoadMap);
