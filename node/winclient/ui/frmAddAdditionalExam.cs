...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmAddAdditionalExam : Form
    {
        ...
        private string ServiceComponentId { get; set; }
        ...
        {
            var findResult = lvExamenesSeleccionados.FindItemWithText(MedicalExamName);
            ...
            //var row = new ListViewItem(new[] { MedicalExamName, CategoryName, ServiceComponentConcatId });
            var row = new ListViewItem(new[] { MedicalExamName, CategoryName, ServiceComponentId });
        ...
        private void grdDataServiceComponent_AfterSelectChange(object sender, Infragistics.Win.UltraWinGrid.AfterSelectChangeEventArgs e)
        {
            ...
            ServiceComponentId = grdDataServiceComponent.Selected.Rows[0].Cells["v_ServiceComponentId"].Value.ToString();
        ...
        private void frmAddAdditionalExam_Load(object sender, EventArgs e)
        {
            ...
            var ListServiceComponent = objServiceBL.GetServiceComponentsByRequired(ref objOperationResult, _serviceId, SiNo.NO);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in lvExamenesSeleccionados.Items)
            {
                ...
                var serviceComponentId = fields[2].Text;
