...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmMaster : Form
    {
        ...
        //GATO ABANDONADOR DE PROYECTO

        private void frmMaster_Load(object sender, EventArgs e)
        {
            //ES BD DE PRODUCCIÓN
            PreChecksBL oPreChecksBL = new PreChecksBL();
            if (!oPreChecksBL.EsBDProduccion())
            {
                this.BackColor = System.Drawing.Color.Red;
                MessageBox.Show("Esta es una BD de PRUEBA CALIDAD","¡IMPORTANTE!");
            }
            ...
            CargarMenus();
            MenuPpal_1.Items[0].Text = "NodeClient Versión:  2.007";
        ...
        private void CargarMenus()
        {
            ...
            if (objAuthorizationList != null)
            {
                ...
                //AutorizationList sistema = new AutorizationList();
                //sistema.I_ApplicationHierarchyId = Constants.ApplicationHierarchySistemaId;
                //sistema.V_Description = "Cerrar Sesión";
                //sistema.V_Form = "";

                //zzz.Insert(0,sistema);

                //var CantMenu = zzz.Count;
                ...
                foreach (var MenuPadre in zzz)
                {
                    ...
                    if (FindResult.Count == 0)
                    {
                        ...
                        // Insertar Menu sistema (por default para todos los usuarios)
                        var c = MenuPpal.Items.Count;
        ...
        private void MenuItemClicked(object sender, EventArgs e)
        {
            ...
            {
                if (((ToolStripItem)sender).Text == "Salir del Sistema")
                {
                    System.Windows.Forms.Application.Exit();
                    return;
                }

                if (((ToolStripItem)sender).Text == "Cerrar Sesión")
                {
