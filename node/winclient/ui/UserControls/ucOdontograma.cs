...
namespace Sigesoft.Node.WinClient.UI.UserControls
{
    public partial class ucOdontograma : UserControl
    {
        ...
        //private OdoContext _odoContext = new OdoContext();
        ...
        public List<ServiceComponentFieldValuesList> _ListaOdontograma =  new List<ServiceComponentFieldValuesList>();
        string _valueOld;
        ...
        public bool IsChangeValueControl
        {
            get
            {
                return _isChangueValueControl;
            }
            set
            {
                _isChangueValueControl = value;
            }
        }

        public OdoContext OdoContext { get; set; }
        ...
        public List<ServiceComponentFieldValuesList> DataSource
        {
            ...
            set
            {
                ...
                if (value != _ListaOdontograma)
                {
                    ...
                    if (OdoContext == OdoContext.FillFromESO)
                    {
                        ClearValueControl();
                        //AddRemoveEventControl(this, "Add");                 
                        var newListaOdontograma = ListOdoToNewEntity(value);
                        _ListaOdontograma = newListaOdontograma;
                        //_ListaOdontograma.AddRange(newListaOdontograma);                      
                        SearchControlAndFill(this, value);

                        OdoContext = OdoContext.None;

                        txtListaOdontograma.Text = _ListaOdontograma.Count.ToString();
                    }
        ...
        private void GetRegionByDiente(Control ctrlContainer, string diente)
        {
            if (_regions == null)          
            ...
            foreach (Control ctrl in ctrlContainer.Controls)
            {
                if (ctrl.Tag != null)
                {
                    if (ctrl is Label)
                    {
                        if (ctrl.Tag.ToString() == diente)
                        {
                            if (ctrl.BackColor == Color.Red) // solo region con cariada
                            {
                                _regions.Add(ctrl.Name);
                            }                           
                        }
                    }
                }
        ...
        private void lbl_Click(object sender, System.EventArgs e)
        {
            ...
            //obtener todas los regiones de una pieza especifica
            var findControl = this.Controls.Find("pbd" + senderCtrl.Tag.ToString(), true);
            ...
            else
            {
                if (senderCtrl.BackColor == System.Drawing.Color.Blue || senderCtrl.BackColor == System.Drawing.Color.White)
                {
                    ...
                    GetRegionByDiente(this, senderCtrl.Tag.ToString());

                    if (_regions.Count == 0) // el diente no tiene ninguna region cariada
                    {
                        listaCaries.RemoveAll(p => p == senderCtrl.Tag.ToString());
                    ...
                    txtPzaCar.Text = CadenaCaries(listaCaries);
                    //Limpio la lista de regiones cariadas
                    _regions = null;
        ...
        {
            if (OdoContext == Common.OdoContext.ClearControls || OdoContext == OdoContext.SearchControlAndFill)
                return;

            OdoContext = OdoContext.FillInternalData;
            ...
            if (Id == (int)Common.LeyendaOdontograma.Ausente)
            {
                ...
                BloquearDesbloquearLabels(this, senderCtrl, "BLOQUEAR", (int)LeyendaOdontograma.Ausente);
            ...
            else if (Id == (int)Common.LeyendaOdontograma.AusenteCorona)
            {
                // Buscamos el control PictureImage para poder saber que imagen vamos a cambiar
                PictureBox ControlPictureBox;
                var ListControlPictureBox = this.Controls.Find(senderCtrl.Tag.ToString(), true);
            ...
            else if (Id == (int)Common.LeyendaOdontograma.ImplanteCorona)
            {
                // Buscamos el control PictureImage para poder saber que imagen vamos a cambiar
                PictureBox ControlPictureBox;
                var ListControlPictureBox = this.Controls.Find(senderCtrl.Tag.ToString(), true);
            ...
            else if (Id == (int)Common.LeyendaOdontograma.CoronaMalAdaptada)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
                ...
                listaAusentes.RemoveAll(p => p == senderCtrl.Tag.ToString().Substring(3, 2));
                txtPzaAus.Text = CadenaAusente(listaAusentes);
                //DataSource = ListOdoToNewEntity(_ListaOdontograma);

                //BloquearDesbloquearLabels(this, senderCtrl, "DESBLOQUEAR");
                //NotExistAusent = false;

            }
            else if (Id == (int)Common.LeyendaOdontograma.CoronaProvisional)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.CarieSevera)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.MaterialProvisional)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.PeriodontitisM1)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.PeriodontitisM2)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.PeriodontitisM3)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.PuenteIni)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.PuenteFin)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
                PictureBox ControlPictureBox;
            ...
            else if (Id == (int)Common.LeyendaOdontograma.ProtesisTotal)
            {
                ...
                //listaAusentes.Add(senderCtrl.Tag.ToString().Substring(3, 2));
                //txtPzaAus.Text = CadenaAusente(listaAusentes);
                txtPzaAus.Text = "11, 12, 13, 14, 15, 16, 17, 18, 21, 22, 23, 24, 25, 26, 27, 28, 31, 32, 33, 34, 35, 36, 37, 38, 41, 42, 43, 44, 45, 46, 47, 48";
                ...
                BloquearDesbloquearLabels(this, senderCtrl, "BLOQUEAR", (int)LeyendaOdontograma.ProtesisTotal);
            }
            else if (Id == -1)
            {
                oOdontograma = new ServiceComponentFieldValuesList();
        ...
        {
            // Flah para no desencadenar el evento textchage de los combos al limpiar los combos
            OdoContext = OdoContext.ClearControls;         
            _isChangueValueControl = false;
            //Otros Controles
            txtPzaCar.Text = string.Empty;
            txtPzaCarAdd.Text = string.Empty;
            txtPzaAus.Text = string.Empty;
            txtPzaAusAdd.Text = string.Empty;
        ...
        public ucOdontograma()
        {
            ...
            txtPzaCarAdd.Name = Constants.PiezaCariesAdd;
            txtPzaAusAdd.Name = Constants.PiezaAusentesAdd;
            ...
            oOdontograma.v_ServiceComponentFieldsId = _v_ServiceComponentFieldsId;
            oOdontograma.v_ServiceComponentId = _v_ServiceComponentId;
            oOdontograma.v_ComponentFieldId = txtPzaCarAdd.Name;
            oOdontograma.v_Value1 = "";
            _ListaOdontograma.Add(oOdontograma);
            ...
            oOdontograma.v_ServiceComponentFieldsId = _v_ServiceComponentFieldsId;
            oOdontograma.v_ServiceComponentId = _v_ServiceComponentId;
            oOdontograma.v_ComponentFieldId = txtPzaAusAdd.Name;
            oOdontograma.v_Value1 = "";
            _ListaOdontograma.Add(oOdontograma);
        ...
        private void SearchControlAndSetValueDefault(Control ctrlContainer)
        {
            foreach (Control ctrl in ctrlContainer.Controls)
            {
                ...
                {                  
                     ((PictureBox)ctrl).Image = global::Sigesoft.Node.WinClient.UI.Resources.diente3;
                }
                if (ctrl.HasChildren)
                    SearchControlAndSetEvents(ctrl);
            }
        ...
        private void BloquearDesbloquearLabels(Control ctrlContainer, ComboBox senderCtrl, string Mode, int tipo = -1)
        {
            string[] ausentes = new string[] 
            { 
                ((int)Common.LeyendaOdontograma.Ausente).ToString(),
                ((int)Common.LeyendaOdontograma.AusenteCorona).ToString(),
                ((int)Common.LeyendaOdontograma.Exodoncia).ToString(),               
                ((int)Common.LeyendaOdontograma.Implante).ToString(),
                ((int)Common.LeyendaOdontograma.ImplanteCorona).ToString(), 
                ((int)Common.LeyendaOdontograma.ProtesisTotal).ToString(),
                ((int)Common.LeyendaOdontograma.PPR).ToString(),
            };

            var itemsCombo = (List<KeyValueDTO>)senderCtrl.DataSource;
            var selectedValue = senderCtrl.SelectedValue;
            ...
            if (Mode == "BLOQUEAR")
            {
                ...
                //_ListaOdontograma.Clear();

                foreach (var item in List)
                {
                    var x = ctrlContainer.Controls.Find(item.ToString(), true);

                    //if (tipo == (int)LeyendaOdontograma.Ausente)
                   // {
                        ((Label)x[0]).Enabled = false;

                    // solo en el caso de los 5 ausentes blanquear las regiones
                    //var found = itemsCombo.FindAll(p => ausentes.Contains(p.Value1));

                    var found = ausentes.Contains(selectedValue);
                    ...
                    if (found)
                    {
                        ...
                        if (Result != null)
                        {
                            ...
                            Result.v_ComponentFieldId = ((Label)x[0]).Name;
                            Result.v_Value1 = ((int)ColorDiente.White).ToString();
                        }
                        else
                        {
                            oOdontograma = new ServiceComponentFieldValuesList();
            ...
            else if (Mode == "DESBLOQUEAR")
            {
                ...
                foreach (var item in List)
                {
                    ...
                    //{
                        ...
                        if (Result != null)
                        {
                            //    // Aqui esta el problema se borra la entidad grabada y se reeplaza por otra con valor de tipo color blanco
                            //_ListaOdontograma.Remove(Result);
                            //oOdontograma = new ServiceComponentFieldValuesList();
        ...
        private void txtPzaCarAdd_TextChanged(object sender, EventArgs e)
        {
            //Llenar la lista para grabar el user control///////////////////////////
            oOdontograma = new ServiceComponentFieldValuesList();
            ...
            int Result = _ListaOdontograma.RemoveAll(p => p.v_ComponentFieldId == txtPzaCarAdd.Name);
            oOdontograma.v_ServiceComponentFieldsId = _v_ServiceComponentFieldsId;
            oOdontograma.v_ServiceComponentId = _v_ServiceComponentId;
            oOdontograma.v_ComponentFieldId = txtPzaCarAdd.Name;
            oOdontograma.v_ServiceComponentFieldValuesId = _v_ServiceComponentFieldValuesId;
            oOdontograma.v_Value1 = txtPzaCarAdd.Text.ToString();

            _ListaOdontograma.Add(oOdontograma);
        }

        private void txtPzaAusAdd_TextChanged(object sender, EventArgs e)
        {
            //Llenar la lista para grabar el user control///////////////////////////
            oOdontograma = new ServiceComponentFieldValuesList();
            ...
            int Result = _ListaOdontograma.RemoveAll(p => p.v_ComponentFieldId == txtPzaAusAdd.Name);
            oOdontograma.v_ServiceComponentFieldsId = _v_ServiceComponentFieldsId;
            oOdontograma.v_ServiceComponentId = _v_ServiceComponentId;
            oOdontograma.v_ComponentFieldId = txtPzaAusAdd.Name;
            oOdontograma.v_ServiceComponentFieldValuesId = _v_ServiceComponentFieldValuesId;
            oOdontograma.v_Value1 = txtPzaAusAdd.Text.ToString();
        ...
        {
            OdoContext = Common.OdoContext.SearchControlAndFill;
            ...
            foreach (var item in DataSourceOrdenado)
            {
                ...
                else if (ctrl1[0].GetType() == typeof(ComboBox))
                {
                    ...
                    if (ctrl1[0].Name == item.v_ComponentFieldId)
                    {
                        ...
                        if (int.Parse(item.v_Value1) == (int)Common.LeyendaOdontograma.Ausente
                                || int.Parse(item.v_Value1) == (int)Common.LeyendaOdontograma.AusenteCorona
                            )                           
                        {
                            // Buscamos el control PictureImage para poder saber que imagen vamos a cambiar                        
                            var controlPb = this.Controls.Find(ctrl1[0].Tag.ToString(), true)[0];
                            ((PictureBox)controlPb).Image = global::Sigesoft.Node.WinClient.UI.Resources.dienteausente;
                        }
                        else if (int.Parse(item.v_Value1) == (int)Common.LeyendaOdontograma.Exodoncia)
                        {
                            var controlPb = this.Controls.Find(ctrl1[0].Tag.ToString(), true)[0];
                            ((PictureBox)controlPb).Image = global::Sigesoft.Node.WinClient.UI.Resources.Exodoncia;
                        }
                        else if (int.Parse(item.v_Value1) == (int)Common.LeyendaOdontograma.Implante
                            || int.Parse(item.v_Value1) == (int)Common.LeyendaOdontograma.ImplanteCorona)
                        {
                            var controlPb = this.Controls.Find(ctrl1[0].Tag.ToString(), true)[0];
                            ((PictureBox)controlPb).Image = global::Sigesoft.Node.WinClient.UI.Resources.Implante;
                        }
                ...
                else if (ctrl1[0].GetType() == typeof(TextBox))
                {
                    if (ctrl1[0].Name == item.v_ComponentFieldId)
                    {
                        ...
                        else if (ctrl1[0].Name == Constants.PiezaAusentes)
                        {
                            if (item.v_Value1 != string.Empty)
                            {
                                string[] Dientes = item.v_Value1.Split(';');
                        ...
                        else if (ctrl1[0].Name == "N002-ODO00000199")
                        {
                            ((TextBox)ctrl1[0]).Text = item.v_Value1;
                        }
                        else if (ctrl1[0].Name == "N002-ODO00000200")
                        {
                            ((TextBox)ctrl1[0]).Text = item.v_Value1;
                        }
                    }
