...
namespace Sigesoft.Node.WinClient.UI.UserControls
{
    public partial class ucBoton : UserControl
    {
        ...
        private void btnBoton_Click(object sender, EventArgs e)
        {
            ...
            else if (Examen == "ADMINISTRACIÓN")
            {
                rutaOrigen = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgAdminOrigen").ToString());
                rutaDestino = Common.Utils.GetApplicationConfigValue("ImgAdminDestino").ToString() + Dni + "-" + Fecha;
            ...
            else if (Examen == "MEDICINA")
            {
                rutaOrigen = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgMedicinaOrigen").ToString());
                rutaDestino = Common.Utils.GetApplicationConfigValue("ImgMedicinaDestino").ToString() + Dni + "-" + Fecha;
            ...
            else if (Examen == "PSICOLOGÍA")
            {
                rutaOrigen = new DirectoryInfo(Common.Utils.GetApplicationConfigValue("ImgPsicoOrigen").ToString());
                rutaDestino = Common.Utils.GetApplicationConfigValue("ImgPsicoDestino").ToString() + Dni + "-" + Fecha;
