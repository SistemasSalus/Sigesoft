...
namespace Sigesoft.Node.WinClient.UI
{
    public class Utils
    {
        ...
        public static void LoadDropDownList(ComboBox prmDropDownList, string prmDataTextField = null, string prmDataValueField = null, List<KeyValueDTO> prmDataSource = null, DropDownListAction? prmDropDownListAction = null, bool autoComplete = false)
        {
            ...
            if (prmDataSource != null)
            {
                if (prmDataSource.Count != 0)
                {
                    ...
                    if (autoComplete)
                    {
                        ...
                        stringCol.AddRange(prmDataSource.Select(p => p.Value1).ToArray());

                        prmDropDownList.DropDownStyle = ComboBoxStyle.DropDown;
                        prmDropDownList.AutoCompleteCustomSource = stringCol;
                        prmDropDownList.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
                        prmDropDownList.AutoCompleteSource = AutoCompleteSource.CustomSource;
                    }
