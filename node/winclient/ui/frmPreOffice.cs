...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmPreOffice : Form
    {
        ...
        private void frmPreOffice_Load(object sender, EventArgs e)
        {
            ...
            var componentProfile = _serviceBL.GetRoleNodeComponentProfileByRoleNodeId_(Globals.ClientSession.i_CurrentExecutionNodeId, Globals.ClientSession.i_RoleId.Value);
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DialogResult Result = MessageBox.Show("¿Desea abrir el Nuevo Sistema de Colas", "CONFIRMACIÓN!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (Result == DialogResult.Yes)
                    {
                        string strConn = "SIGESOftConnStr";
                        var o = (KeyValueDTO)ddlComponentId.SelectedItem;

                        frmConsultorio frm = new frmConsultorio(strConn, o.Value1);
                    ...
                    else
                    {
                        ...
                        frmOffice frm = new frmOffice(o.Value1);
                        frm._componentIds = _componentIds;
                        frm.MdiParent = this.MdiParent;
                        frm.Show();
