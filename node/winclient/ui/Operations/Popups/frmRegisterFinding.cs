...
namespace Sigesoft.Node.WinClient.UI.Operations.Popups
{
    public partial class frmRegisterFinding : Form
    {
        ...
        {
            //lblNombreExamen.Text = ComponentName;
            txtHallazgos.Select();
            this.Text = string.Format("Registro de Hallazgos <{0} / {1}> ", ComponentName, FieldName);
            //gbInfoComponente.Text = string.Format("Información del examen: <{0} / {1}> ", ComponentName, FieldName);
        ...
        {
            //if (uvRegisterFindings.Validate(true, false).IsValid)
            //{
