...
namespace Sigesoft.Node.WinClient.UI.Operations.Popups
{
    public partial class frmAddAuxiliaryExam : Form
    {
        ...
        private void LoadComboBox()
        {
            ...
            Utils.LoadDropDownList(cbCategoria, "Value1", "Id", BLL.Utils.GetSystemParameterForCombo(ref objOperationResult, 116, null), DropDownListAction.Select);       
            //Utils.LoadComboTreeBoxList(cbCategoria, BLL.Utils.GetSystemParameterForComboTreeBox(ref objOperationResult, 116, null), DropDownListAction.All);
