...
{
    public partial class frmEsoNew : Form
    {
        ...
        public frmEsoNew(string serviceId, string componentIdByDefault, string action)
        {
            InitializeComponent();
        ...
        {
            _i_RoleId = Globals.ClientSession.i_RoleId.Value;
            _i_NodeId = Globals.ClientSession.i_CurrentExecutionNodeId; ;
            ...
            using (new LoadingClass.PleaseWait(this.Location, "Cargando..."))
            {
                ...
                //// Setear por default un examen componente desde consultorio
                //// DAVID: AL SER ESTATICO SE DEBE HACER NUEVA LÓGIGA
        ...
        private void BuildMinimalMenu()
        {
            try
            {
                // Lista de Componentes / Campos / Values
                OperationResult objOperationResult = new OperationResult();
                _tmpServiceComponentsForBuildMenuList = new ServiceBL().GetServiceComponentsForBuildMinimalMenu(ref objOperationResult, _serviceId, _i_RoleId, _i_NodeId);
            ...
            else
            {
                ...
                foreach (var item in component.Fields)
                {
                    ...
                    if (fields.Length != 0)
                    {
                        ...
                        {
                            //DAVID: ACA SE ARMA LA DATA QUE SE GRAVA EN SCFVALUES
                    ...
                    if (field.Length != 0)
                    {
                        ...
                        switch ((ControlType)cf.i_ControlId)
                        {
                            ...
                            case ControlType.Lista:
                                ...
                                //    cbList.SelectedValue = string.IsNullOrEmpty(cf.v_DefaultText) ? "-1" : cf.v_DefaultText;
                                //}
                                cbList.SelectedValue = string.IsNullOrEmpty(cf.v_DefaultText) ? "-1" : cf.v_DefaultText.ToString();
                                break;
                            case ControlType.UcOdontograma:
...
//DAVID MIRA ACA
        ...
        private void EnviarPdfTrabajador()
        {
            ...
            try
            {
                ...
                string from = configEmail[2].Value1.ToLower();
                string fromPassword = configEmail[4].Value1;
                string subject = "Resultado de prueba Covid-19";
                bool enableSsl = Convert.ToBoolean(int.Parse(configEmail[3].Value1));
                string message = string.Format("Resultados del trabajador: {0}", _personName);
                string ruta = Common.Utils.GetApplicationConfigValue("rutaReportes").ToString();
