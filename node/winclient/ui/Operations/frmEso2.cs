...
{
    public partial class frmEso2 : Form
    {
        ...
        public frmEso2(string serviceId, string componentIdByDefault, string action)
        {
            InitializeComponent();
        ...
        private void frmEso_Load(object sender, EventArgs e)
        {
            ...
            _i_NodeId = int.Parse(Common.Utils.GetApplicationConfigValue("NodeId"));
