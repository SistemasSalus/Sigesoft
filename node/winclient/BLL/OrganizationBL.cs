   ...
   public class OrganizationBL
    {
       ...
       public List<organizationDto> GetOrganizationPorNombre(string nombre)
       {
           try
           {
               SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
               ...
               var objEntity = (from a in dbContext.organization
                                where a.v_Name.Contains(nombre) && a.i_IsDeleted ==0
       ...
       public List<locationDto> GetLocationPorNombre(string organizationId, string nombre)
       {
           try
           {
               SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
               ...
               var objEntity = (from a in dbContext.location
                                where a.v_OrganizationId == organizationId && a.v_Name.Contains(nombre)
       ...
       public List<protocolDto> GetProtocolPorNombre(string organizationId, string nombre)
       {
           try
           {
               SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
               ...
               var objEntity = (from a in dbContext.protocol
                                where a.v_CustomerOrganizationId == organizationId && a.v_Name.Contains(nombre)
       ...
       public List<OrganizationList> GetAllOrganizationsAndLocation()
       {
           //mon.IsActive = true;
           ...
           try
           {
               ...
               var query = (from A in dbContext.organization
                           ...
                           where A.i_IsDeleted == 0 && B.i_IsDeleted == 0
                           select new OrganizationList
                           {
                               v_OrganizationId = A.v_OrganizationId,
       ...
       public List<OrdenReportes> GetAllOrdenReporteNuevo(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression)
       {
           try
           {
               ...
               var query = from A in dbContext.systemparameter
                           where A.i_IsDeleted == 0 && A.i_GroupId == 266
