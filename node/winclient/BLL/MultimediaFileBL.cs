    ...
    public class MultimediaFileBL
    {
        ...
        public List<FileInfoDto> GetMultimediaFiles(ref OperationResult pobjOperationResult, string[] ServiceComponentId)
        {
            ...
            try
            {
                ...
                var objEntity = (from a in dbContext.multimediafile
                                 join b in dbContext.servicecomponentmultimedia on a.v_MultimediaFileId equals b.v_MultimediaFileId
                                 where ServiceComponentId.Contains(b.v_ServiceComponentId)
                                 && a.i_IsDeleted == 0
                                 select new FileInfoDto
                                 {
                                     MultimediaFileId = a.v_MultimediaFileId,
        ...
        public ServiceComponentMultimediaFileList GetMultimediaFileByIdFromReportManager(ref OperationResult pobjOperationResult, string MultimediaFileId)
        {
            //mon.IsActive = true;
            ...
            try
            {
                ...
                var objEntity = (from a in dbContext.multimediafile
                                 ...
                                 where a.v_MultimediaFileId == MultimediaFileId
                                 && a.i_IsDeleted == 0
                                 select new ServiceComponentMultimediaFileList
                                 {
                                     v_MultimediaFileId = a.v_MultimediaFileId,
                                     v_FileName = a.v_FileName,
                                     b_File = a.b_File,
                                     d_ServiceDate = b.servicecomponent.service.d_ServiceDate,
                                     v_ComponentName = b.servicecomponent.component.v_Name,
                                     v_DocNumber = a.person.v_DocNumber,
