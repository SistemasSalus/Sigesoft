    ...
    public class SecurityBL
    {
        ...
        public List<AutorizationList> GetAuthorization(ref OperationResult pobjOperationResult, int pintNodeId, int pintSystemUserId)
        {
            ...
            try
            {
                ...
                AutorizationList o = new AutorizationList();
                o.V_Description = "Sistema";
                o.I_ParentId = 1;
                o.I_ApplicationHierarchyId = 3000;
                o.I_ApplicationHierarchyTypeId = 1;
                objAutorizationList.Add(o);

                o = new AutorizationList();
                o.V_Description = "Cerrar Sesión";
                o.I_ParentId = 3000;
                o.I_ApplicationHierarchyId = 3001;
                o.I_ApplicationHierarchyTypeId = 2;
                objAutorizationList.Add(o);

                o = new AutorizationList();
                o.V_Description = "Salir del Sistema";
                o.I_ParentId =3000;
                o.I_ApplicationHierarchyId = 3002;
                o.I_ApplicationHierarchyTypeId = 2;
                objAutorizationList.Add(o);
