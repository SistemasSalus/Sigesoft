            ...
            try
            {
                ...
                var query = from A in dbContext.componentfields
                            ...
                            select new MedicalExamFieldsList
                            {
                                ...
                                v_Group  =A.v_Group ,
                                v_Abbreviation =  B.v_abbreviation,
                                ...
                                i_NroDecimales = B.i_NroDecimales.Value,
                                i_Enabled = B.i_Enabled.Value,
                                i_ReadOnly = B.i_ReadOnly.Value,
                                i_Column = B.i_Column.Value,
                                i_WidthControl = B.i_WidthControl.Value,
