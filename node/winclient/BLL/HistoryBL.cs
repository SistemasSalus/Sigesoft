...
namespace Sigesoft.Node.WinClient.BLL
{
   public class HistoryBL
   {
      ...
      public List<PersonMedicalHistoryList> GetPersonMedicalHistoryPagedAndFilteredByPersonId(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, string pstrPersonId)
      {
          ...
          try
          {
              ...
              var query = from A in dbContext.personmedicalhistory
                          ...
                          join D in dbContext.diseases on A.v_DiseasesId equals D.v_DiseasesId into D_join
      ...
      public void AddPersonMedicalHistory(ref OperationResult pobjOperationResult, List<personmedicalhistoryDto> pobjpersonmedicalhistoryAdd, List<personmedicalhistoryDto> pobjpersonmedicalhistoryUpdate, List<personmedicalhistoryDto> pobjpersonmedicalhistoryDelete, List<string> ClientSession)
      {
          ...
          try
          {
              ...
              foreach (var item in pobjpersonmedicalhistoryAdd)
              {
                  ...
                  // OBTENER NO DEFINIDO para eliminarlo logicamente y luego insertar el mismo como nuevo
                  var query = (from A in dbContext.personmedicalhistory
                               where (A.v_PersonId == item.v_PersonId) && (A.v_DiseasesId == item.v_DiseasesId) &&
                                     (A.i_AnswerId == (int)SiNo.NONE) &&
                  ...
                  if (query != null)
                  {
                      ...
                      query.i_UpdateUserId = Int32.Parse(ClientSession[2]);
                      query.i_IsDeleted = (int)SiNo.SI;
                  }               
              ...
              if (pobjpersonmedicalhistoryUpdate != null)
              {
                  ...
                  foreach (var item in pobjpersonmedicalhistoryUpdate)
                  {
                      ...
                      objEntitySource1.i_IsDeleted = 0;
                      objEntitySource1.i_AnswerId = item.i_AnswerId;
       ...
       //AGVR
      public void AddPersonMedicalHistoryFromESO(ref OperationResult pobjOperationResult, List<personmedicalhistoryDto> pobjpersonmedicalhistoryAdd, List<string> ClientSession)
      {
          int isDeleted = (int)SiNo.NO;
          string NewId = "(No generado)";
          try
       ...
       // AGVR
      public void UpdatePersonMedicalHistoryFromESO(ref OperationResult pobjOperationResult, List<personmedicalhistoryDto> pobjpersonmedicalhistoryUpdate, List<string> ClientSession)
      {
           int isDeleted = (int)SiNo.NO;
          string NewId = "(No generado)";
          try
          {
              ...
              if (pobjpersonmedicalhistoryUpdate != null)
              {
                  ...
                  foreach (var item in pobjpersonmedicalhistoryUpdate)
                  {
                      // Obtener la entidad fuente
                      var objEntitySource1 = (from a in dbContext.personmedicalhistory
                                              where (a.v_PersonId == item.v_PersonId) && 
                                                    (a.v_DiseasesId == item.v_DiseasesId) &&
                                                    (a.i_IsDeleted == isDeleted)
                                              select a).FirstOrDefault();
      ...
      // AGVR
      public void DeletePersonMedicalHistoryFromESO(ref OperationResult pobjOperationResult, string personId, string diseasesId, List<string> ClientSession)
      {
          int isDeleted = (int)SiNo.NO;
          string NewId = "(No generado)";
          try
          {
            ...
            var objEntitySource1 = (from a in dbContext.personmedicalhistory
                                    where (a.v_PersonId == personId) &&
                                          (a.v_DiseasesId == diseasesId) &&
                                          (a.i_AnswerId == (int)SiNo.SI || a.i_AnswerId == (int)SiNo.NONE) &&                               
                                          (a.i_IsDeleted == isDeleted)
                                    select a).FirstOrDefault();
      ...
      // AGVR
      public void NoDefinePersonMedicalHistoryFromESO(ref OperationResult pobjOperationResult, personmedicalhistoryDto pobjpersonmedicalhistory, List<string> ClientSession)
      {
          int isDeleted = (int)SiNo.NO;
          string NewId = "(No generado)";
          try
          {
              ...
              // Obtener la entidad fuente
              var objEntitySource1 = (from a in dbContext.personmedicalhistory
                                      where (a.v_PersonId == pobjpersonmedicalhistory.v_PersonId) &&
                                            (a.v_DiseasesId == pobjpersonmedicalhistory.v_DiseasesId) &&
                                            (a.i_AnswerId == (int)SiNo.SI || a.i_AnswerId == (int)SiNo.NO) && 
                                            (a.i_IsDeleted == isDeleted)
                                      select a).FirstOrDefault();
              ...
              #region Crear Person Medical
                ...
                NewId = Common.Utils.GetNewId(intNodeId, Utils.GetNextSecuentialId(intNodeId, 40), "PH");
                objEntity1.v_PersonMedicalHistoryId = NewId;
                objEntity1.v_PersonId = pobjpersonmedicalhistory.v_PersonId;
                objEntity1.v_DiseasesId = pobjpersonmedicalhistory.v_DiseasesId;             
                objEntity1.i_AnswerId = pobjpersonmedicalhistory.i_AnswerId;
                dbContext.AddTopersonmedicalhistory(objEntity1);
      ...
      public List<NoxiousHabitsList> GetNoxiousHabitsPagedAndFilteredByPersonId1(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, string pstrPersonId)
      {
          //mon.IsActive = true;
          try
          {
      ...
      public List<NoxiousHabitsList> GetNoxiousHabitsReport(string pstrPersonId)
      {
          ...
          try
          {
              ...
              var query = (from A in dbContext.noxioushabits
                          join B in dbContext.systemparameter on new { a = A.i_TypeHabitsId.Value, b = (int)SystemParameterGroups.HabitosNocivos }
                                                         equals new { a = B.i_ParameterId, b = B.i_GroupId } into B_join
                          from B in B_join.DefaultIfEmpty()
      ...
      public List<FamilyMedicalAntecedentsList> GetFamilyMedicalAntecedentsPagedAndFilteredByPersonId1(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression, string pstrPersonId)
      {
          //mon.IsActive = true;
          try
          {
      ...
      public List<FamilyMedicalAntecedentsList> GetFamilyMedicalAntecedentsReport(string pstrPersonId)
      {
          ...
          try
          {
              ...
              var query1 = query.Select((x, index) => new FamilyMedicalAntecedentsList
              {
                  ...
                  v_Comment = x.v_Comment,
                  v_FullAntecedentName = x.v_FullAntecedentName + ", " + x.v_Comment,
                  DxAndComment = x.DxAndComment + ", " + x.v_Comment
              }).ToList();
