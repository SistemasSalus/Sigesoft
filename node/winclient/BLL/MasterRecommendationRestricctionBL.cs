   ...
   public class MasterRecommendationRestricctionBL
    {
       ...
       public void AddMasterRecommendationRestricction(ref OperationResult pobjOperationResult, masterrecommendationrestricctionDto pobjDtoEntity, List<string> ClientSession)
        {
            //mon.IsActive = true;
