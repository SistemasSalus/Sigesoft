...
namespace Sigesoft.Node.WinClient.BLL
{
   public class CalendarBL
   {
           ...
           try
           {
               using (SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel())
               {
                   ...
                   var query = from A in dbContext.calendar
                           ...
                           join J in dbContext.protocol on D.v_ProtocolId equals J.v_ProtocolId into J_join
                           ...
                           join oc in dbContext.organization on J.v_CustomerOrganizationId equals oc.v_OrganizationId into oc_join
                           ...
                           join J1 in dbContext.systemuser on A.i_InsertUserId.Value equals J1.i_SystemUserId into J1_join
                           from J1 in J1_join.DefaultIfEmpty()

                           join J2 in dbContext.systemuser on A.i_UpdateUserId.Value equals J2.i_SystemUserId into J2_join
                           from J2 in J2_join.DefaultIfEmpty()

                           where (A.i_IsDeleted == isDeleted)
                                 && (A.d_DateTimeCalendar >= pdatBeginDate.Value && A.d_DateTimeCalendar <= pdatEndDate.Value)

                           select new CalendarList
                           {
                               v_CalendarId = A.v_CalendarId,
                               v_Nodo = A.v_CalendarId.Substring(0,4),
                               ...
                               v_OrganizationLocationService = oc.v_Name + " / " + lc.v_Name,
                   ...
                   else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 4)
                   {
       ...
       public bool EsAdicionalAlReagendar(string serviceId, string componentId)
       {
           SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();

           var query = (from A in dbContext.servicecomponent where A.v_ServiceId == serviceId && A.v_ComponentId == componentId && A.i_IsRequiredId == (int)SiNo.SI && A.i_IsDeleted == 0 select A).FirstOrDefault();
           if (query != null)           
               return true;          
       ...
       public string AddShedule(ref OperationResult pobjOperationResult, calendarDto pobjDtoEntity, List<string> ClientSession, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId, string pstrNuevoContinuacion, string pstrEmpresaFacturacionId, string pstrSede)
       {
           //mon.IsActive = true;
           string NewId = "(No generado)";
           string ServiceId = String.Empty;
           ...
           try
           {
               ...
               objServiceDto.i_FlagAgentId = 1;
               objServiceDto.v_Motive = string.Empty;
               objServiceDto.v_EmpresaFacturacionId = pstrEmpresaFacturacionId;
               objServiceDto.v_Sede = pstrSede;
               if (pstrNuevoContinuacion == "Nuevo")
               {
                   // Es un nuevo Servicio
                   ServiceId = _ObjServiceBL.AddService(ref objOperationResult, objServiceDto, ClientSession);

                   objProtocolComponentList = _objProtocolBL.GetProtocolComponentsforAddSchedule(ref objOperationResult, pstrProtocolId);
               ...
               else if (pstrNuevoContinuacion == "Reagendar")
               {
                    // Es un nuevo Servicio
                   ServiceId = _ObjServiceBL.AddService(ref objOperationResult, objServiceDto, ClientSession);
                   ...
                   for (int i = 0; i <= objProtocolComponentList.Count - 1; i++)
                   {
                       ...
                       objServiceComponentDto.i_ServiceComponentStatusId = (int)Common.ServiceStatus.PorIniciar;
                       objServiceComponentDto.i_QueueStatusId = (int)Common.QueueStatusId.LIBRE;
                       objServiceComponentDto.i_IsRequiredId = EsAdicionalAlReagendar(pobjDtoEntity.v_ServiceId, ComponentId) == true ? (int)Common.SiNo.SI : (int)Common.SiNo.NO;
                       objServiceComponentDto.i_Iscalling = (int)Common.Flag_Call.NoseLlamo;
                       objServiceComponentDto.i_IsManuallyAddedId = (int)Common.SiNo.NO;
                       _ObjServiceBL.AddServiceComponent(ref objOperationResult, objServiceComponentDto, ClientSession);
       ...
       public string AddShedule(ref OperationResult pobjOperationResult, calendarDto pobjDtoEntity, List<string> ClientSession, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId, string pstrNuevoContinuacion, string pstrEmpresaFacturacionId, string pstrSede, DateTime FechaServicio)
       {
           //mon.IsActive = true;
           string NewId = "(No generado)";
           string ServiceId = String.Empty;
           ...
           try
           {
               ...
               //Se setea el estado de la aptitud en "Sin Aptitud" en caso sea un Eso
               objServiceDto.i_AptitudeStatusId = (int)Common.AptitudeStatus.SinAptitud;
               objServiceDto.d_ServiceDate = FechaServicio;
               objServiceDto.d_GlobalExpirationDate = null;
               objServiceDto.d_ObsExpirationDate = null;
               objServiceDto.i_FlagAgentId = 1;
               objServiceDto.v_Motive = string.Empty;
        ...
        public string AddSheduleWEB(ref OperationResult pobjOperationResult, calendarDto pobjDtoEntity, List<string> ClientSession, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId, string pstrNuevoContinuacion, string pstrEmpresaFacturacionId, string pstrSede, DateTime FechaServicio, int TipoEmpresaCovid)
       {
           //mon.IsActive = true;
           string NewId = "(No generado)";
           string ServiceId = String.Empty;
           ...
           try
           {
               ...
               objServiceDto.v_EmpresaFacturacionId = pstrEmpresaFacturacionId;
               objServiceDto.v_Sede = pstrSede;
               objServiceDto.TipoEmpresaCovidId = TipoEmpresaCovid;
               objServiceDto.TecnicoCovid = ClientSession[5].ToString();
               if (pstrNuevoContinuacion == "Nuevo")
               {
                   // Es un nuevo Servicio
                   ServiceId = _ObjServiceBL.AddService(ref objOperationResult, objServiceDto, ClientSession);
        ...
        public string AddSheduleWEBOtrasClinicas(ref OperationResult pobjOperationResult, calendarDto pobjDtoEntity, List<string> ClientSession, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId, string pstrNuevoContinuacion, string pstrEmpresaFacturacionId, string pstrSede, DateTime FechaServicio, int ClinicaProvinciaId)
       {
           //mon.IsActive = true;
           string NewId = "(No generado)";
           string ServiceId = String.Empty;
           ...
           try
           {
               ...
               objServiceDto.v_EmpresaFacturacionId = pstrEmpresaFacturacionId;
               objServiceDto.v_Sede = pstrSede;
               objServiceDto.ClinicaExternad = ClinicaProvinciaId;
               objServiceDto.TecnicoCovid = ClientSession[5].ToString();
               if (pstrNuevoContinuacion == "Nuevo")
               {
                   // Es un nuevo Servicio
       ...
       public void Reschedule(ref OperationResult pobjOperationResult, List<string> ClientSession, string pstrCalendarId, DateTime pdatDateTimeStar, int pintddlVipId, string pstrProtocolId, string pstrPacientId, int pstrMasterServiceId)
       {
           ...
           try
           {
               ...
               string Result = AddShedule(ref pobjOperationResult, objCalendarDto, ClientSession, pstrProtocolId, pstrPacientId, pstrMasterServiceId,"Reagendar","","");
       ...
       public List<CalendarList> GetPacientInLineByComponentId1(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrComponentId, DateTime CurrentDate, DateTime CurrentDateLimit, string[] pobjComponentIds)
       {
      
           int isDeleted = (int)SiNo.NO;
           int lineStatus = (int)LineStatus.EnCircuito;
           int isRequired = (int)SiNo.SI;
           int serviceStatus = (int)ServiceComponentStatus.Culminado;

           try
           {
               SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
               //****Optimizar Query trae data que no sirve en la fecha
               var query = from A in dbContext.calendar
                           join B in dbContext.person on A.v_PersonId equals B.v_PersonId
                           join C in dbContext.service on A.v_ServiceId equals C.v_ServiceId
                           join D in dbContext.servicecomponent on A.v_ServiceId equals D.v_ServiceId
                           ...
                           // Empresa / Sede Cliente  ********************************************************
                           join ow in dbContext.organization on J.v_CustomerOrganizationId equals ow.v_OrganizationId into ow_join
                           from ow in ow_join.DefaultIfEmpty()

                           join lw in dbContext.location on new { a = J.v_CustomerLocationId, b = J.v_WorkingLocationId }
                           ...
                           where A.i_IsDeleted == isDeleted &&
                                (A.d_DateTimeCalendar >= CurrentDate.Date && A.d_DateTimeCalendar <= CurrentDateLimit.Date) &&
                                 A.i_LineStatusId == lineStatus &&
                                 D.i_IsRequiredId == isRequired &&
                                 //C.i_ServiceStatusId != serviceStatus &&
                                 D.i_ServiceComponentStatusId != serviceStatus 
                           ...
                           select new CalendarList
                           {
                               ...
                               v_LastnameFirstname = B.v_FirstLastName + " " + B.v_SecondLastName 
               ...
               if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 3)
               {
                   return query1.ToList().FindAll(p => p.v_Nodo == "N003");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 4)
               {
                   return query1.ToList().FindAll(p => p.v_Nodo == "N004");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 5)
               {
                   return query1.ToList().FindAll(p => p.v_Nodo == "N005");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 6)
               {
                   return query1.ToList().FindAll(p => p.v_Nodo == "N006");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 7)
               {
                   return query1.ToList().FindAll(p => p.v_Nodo == "N007");
               }
       ...
       public List<CalendarList> GetCallPacientPagedAndFilteredGroupByCategoryId(ref OperationResult pobjOperationResult, int? pintPageIndex, int? pintResultsPerPage, string pstrSortExpression, string pstrFilterExpression)
       {
           ...
           int isDeleted = (int)SiNo.NO;
           int llamando = (int)QueueStatusId.LLAMANDO;
           int ocupado = (int)QueueStatusId.OCUPADO;
           ...
           try
           {
               ...
               var query = (from A in dbContext.servicecomponent
                            ...
                            from G in G_join.DefaultIfEmpty()
                             ...
                             join Usu in dbContext.systemuser on A.i_InsertUserId equals Usu.i_InsertUserId

                            join Pro in dbContext.professional on Usu.v_PersonId equals Pro.v_PersonId

                            where (A.i_IsDeleted == isDeleted && E.i_LineStatusId == (int)LineStatus.EnCircuito) &&
                                  (A.i_QueueStatusId == llamando || A.i_QueueStatusId == ocupado) &&
                            ...
                            select new CalendarList
                            {
                                ...
                                v_Nodo = B.v_ServiceId.Substring(0,4),
                                v_NameOffice = Pro.v_ProfessionalInformation + " - " + D1.v_Name,
                                ...
                                InformacionAdicional = Pro.v_ProfessionalInformation
                            }).ToList();
               ...
               if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 3)
               {
                   return objData.ToList().FindAll(p => p.v_Nodo == "N003");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 4)
               {
                   return objData.ToList().FindAll(p => p.v_Nodo == "N004");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 5)
               {
                   return objData.ToList().FindAll(p => p.v_Nodo == "N005");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 6)
               {
                   return objData.ToList().FindAll(p => p.v_Nodo == "N006");
               }
               else if (int.Parse(Common.Utils.GetApplicationConfigValue("NodeId")) == 7)
               {
                   return objData.ToList().FindAll(p => p.v_Nodo == "N007");
               }
       ...
       {
           //DAVID ACA Agregar lo que piden
           try
           {
               SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
               ...
               var query = from A in dbContext.calendar
                           ...
                           join L in dbContext.organization on new { a = D.v_EmpresaFacturacionId }
                           ...
                           join Q in dbContext.organization on new { a = D.v_EmpresaFacturacionId }
                                   equals new { a = Q.v_OrganizationId } into Q_join
                           ...
                           select new CalendarList
                           {
                               ...
                               d_Birthdate = B.d_Birthdate.Value,
                               v_EsoTypeName = K.v_Value1,
                               v_OrganizationName = L.v_Name + "      Sede: " + D.v_Sede,
                               v_OrganizationLocationService = N.v_Name + "      Sede: " + O.v_Name,
                               v_OrganizationIntermediaryName = P.v_Name,
                               v_DocNumber = B.v_DocNumber,
                               b_PersonImage = B.b_PersonImage,
                               b_Logo = logoEmpresa,
                               v_CustomerOrganizationName = Q.v_Name,
                               v_CurrentOccupation = B.v_CurrentOccupation,
                               d_ServiceDate = A.d_UpdateDate,
                           };
