...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class organizationDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_VigCovid19 { get; set; }

        [DataMember()]
        public Nullable<Int32> i_TipoFormatoCovid19 { get; set; }

        [DataMember()]
        public Nullable<Boolean> i_RegCovid { get; set; }
        ...
        public organizationDto(String v_OrganizationId, String v_OrganizationPadreId, Nullable<Int32> i_OrganizationTypeId, Nullable<Int32> i_SectorTypeId, String v_IdentificationNumber, String v_Name, String v_Address, String v_PhoneNumber, String v_Mail, String v_ContacName, String v_Observation, Nullable<Int32> i_NumberQuotasOrganization, Nullable<Int32> i_NumberQuotasMen, Nullable<Int32> i_NumberQuotasWomen, Nullable<Int32> i_DepartmentId, Nullable<Int32> i_ProvinceId, Nullable<Int32> i_DistrictId, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Byte[] b_Image, String v_ContactoMedico, String v_EmailMedico, Nullable<Decimal> r_Factor, Nullable<Decimal> r_FactorMed, String v_SectorName, String v_SectorCodigo, String v_Contacto, String v_EmailContacto, Nullable<Int32> i_VigCovid19, Nullable<Int32> i_TipoFormatoCovid19, Nullable<Boolean> i_RegCovid, List<nodeorganizationlocationprofileDto> nodeorganizationlocationprofile, List<nodeorganizationlocationwarehouseprofileDto> nodeorganizationlocationwarehouseprofile, List<nodeorganizationprofileDto> nodeorganizationprofile, List<portaluseraccessDto> portaluseraccess, List<usuarioregcovidorganizationDto> usuarioregcovidorganization, List<warehouseDto> warehouse)
        {
			this.v_OrganizationId = v_OrganizationId;
			this.v_OrganizationPadreId = v_OrganizationPadreId;
			...
			this.i_VigCovid19 = i_VigCovid19;
			this.i_TipoFormatoCovid19 = i_TipoFormatoCovid19;
			this.i_RegCovid = i_RegCovid;
