...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class protocolDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> v_StatusProtocolId { get; set; }
        ...
        [DataMember()]
        public Nullable<Int32> i_ProfileId { get; set; }

        [DataMember()]
        public Nullable<Int32> i_TypeReport { get; set; }
        ...
        public protocolDto(String v_ProtocolId, String v_Name, Nullable<Int32> v_StatusProtocolId, String v_EmployerOrganizationId, String v_EmployerLocationId, Nullable<Int32> i_EsoTypeId, String v_GroupOccupationId, String v_CustomerOrganizationId, String v_CustomerLocationId, String v_WorkingOrganizationId, String v_WorkingLocationId, String v_CostCenter, Nullable<Int32> i_MasterServiceTypeId, Nullable<Int32> i_MasterServiceId, Nullable<Int32> i_HasVigency, Nullable<Int32> i_ValidInDays, Nullable<Int32> i_IsActive, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_ProfileId, Nullable<Int32> i_TypeReport, List<protocolcomponentDto> protocolcomponent, List<protocolsystemuserDto> protocolsystemuser, List<serviceDto> service, List<serviceorderdetailDto> serviceorderdetail)
        {
			...
			this.i_ProfileId = i_ProfileId;
			this.i_TypeReport = i_TypeReport;
