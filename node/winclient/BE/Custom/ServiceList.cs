...
namespace Sigesoft.Node.WinClient.BE
{
    public class ServiceList
    {
        ...
        //DEBE PERMITIR NULOS PARA QUE NO SE CAIGA
    ...
    public class DatosObtenidosCovid { 
        ...
        public string v_Telefon { get; set; }

        public string FechaUltimaCovid { get; set; }
        public string ResultadpUltimaCovid { get; set; }
