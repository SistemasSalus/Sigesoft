...
namespace Sigesoft.Node.WinClientFast.DA
{
    public class ConsultorioBLDA
    {
        ...
        public List<PacienteAgendado> GetPacienteAgendado(string pstrConn, int pcategoria)
        { 
            ...
            try
            {
                ...
                {
                    db.Open(pDBConn);
                    db.ProcedureName = "[dbo].[ObtenerAgendaporCategoria]";
