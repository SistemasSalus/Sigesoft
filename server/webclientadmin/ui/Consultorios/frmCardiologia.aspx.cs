    ...
    public partial class frmCardiologia : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                btnReporteCardio.OnClientClick = winEdit1.GetSaveStateReference(hfRefresh.ClientID) + winEdit1.GetShowReference("frmVisorReporte.aspx?Mode=Cardio");
                ...
                chkCansancio.Attributes.Add("Tag", "N002-MF000000433");
                chkDiabetes.Attributes.Add("Tag", "N002-MF000000438");
                chkDisplidemia.Attributes.Add("Tag", "N002-MF000000439");
                chkDolorPrecordial.Attributes.Add("Tag", "N002-MF000000430");
                chkIMA.Attributes.Add("Tag", "N002-MF000000431");
                chkMareos.Attributes.Add("Tag", "N002-MF000000434");
                chkObesidad.Attributes.Add("Tag", "N002-MF000000432");
                chkPalpitaciones.Attributes.Add("Tag", "N002-MF000000435");
                chkPerdConciencia.Attributes.Add("Tag", "N002-MF000000436");
                chkHipertension.Attributes.Add("Tag", "N002-MF000000429");
                chkSoplos.Attributes.Add("Tag", "N002-MF000000428");
                chkTabaquismo.Attributes.Add("Tag", "N002-MF000000437");
                chkVarisesMMII.Attributes.Add("Tag", "N002-MF000000440");
                txtOtros.Attributes.Add("Tag", "N002-MF000000441");
               
                txtFrecuenciaCardiaca.Attributes.Add("Tag", "N002-MF000000486");
                txtRitmo.Attributes.Add("Tag", "N002-MF000000453");
                txtIntervPR.Attributes.Add("Tag", "N002-MF000000454");
                txtInterQRS.Attributes.Add("Tag", "N002-MF000000455");
                txtInterQT.Attributes.Add("Tag", "N002-MF000000456");
                txtEjeST.Attributes.Add("Tag", "N002-MF00000463");
                txtEjeQRS.Attributes.Add("Tag", "N002-MF000000464");
                txtInterpretacion.Attributes.Add("Tag", "N002-MF000000465");
                txtRecomendaciones.Attributes.Add("Tag", "N002-MF000000468");
                chkAptoTrabForzoso.Attributes.Add("Tag", "N002-MF000000466");
                chkAptoTrab2500.Attributes.Add("Tag", "N002-MF000000467");
        ...
        protected void grdData_RowClick(object sender, GridRowClickEventArgs e)
        {
            ...
            Session["DniTrabajador"] = dataKeys[9] == null ? "" : dataKeys[9].ToString();
        ...
        protected void btnGrabarElectrocardiograma_Click(object sender, EventArgs e)
        {
            ...
            {
                serviceComponentDto.i_ServiceComponentStatusId = (int)ServiceComponentStatus.Culminado;
