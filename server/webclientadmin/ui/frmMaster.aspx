<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMaster.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.frmMaster_" %>
...
<head runat="server">
    <title>:: Salus Laboris SAC ::.</title>
     <style>
        .header .title {
            background-image: url(../images/logo/salvs-laboris.png);
...
<body>
    ...
    <x:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
        <Regions>
                    ...
                    <Items>
                        <x:ContentPanel ShowBorder="false" CssClass="header" ShowHeader="false" BodyStyle="background-color:#C0D8EF;"
                            ...
                            <table>
                                <tr>
                                    <td class="titlex">
                                        <x:HyperLink ID="HyperLink3" NavigateUrl="~/frmMaster_.aspx" runat="server" Text=":: SIGESOft 2017 ::.">
                                        </x:HyperLink>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="subtitle">
                                        <x:HyperLink ID="HyperLink2" NavigateUrl="~/frmMaster_.aspx" runat="server" Text=":: Sistema de Gestión de Salud Ocupacional ::.">
                                        </x:HyperLink>
                                    </td>
                                </tr>
                                <tr>
            ...
            <x:Region ID="Region3" ShowHeader="false" EnableIFrame="true" IFrameUrl="~/ExternalUser/FRM031.aspx"
